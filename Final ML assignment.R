...
testing<-testing[-1,]
#apply a first ML algorithm for prediction. use rpart to fit a classifiction
#tree to data divided into known classes 
modFitA1 <- rpart(classe ~ ., data=mytraining, method="class")
par(mar=rep(2,4)) #to solve error associated with plot's margins being too large
rpart.plot(modFitA1)#view the decision tree
...
rmarkdown::render("Final ML assignment.R", "pdf_document")
